...
[[ -z $VENDOR ]] && VENDOR="Selfmicro Marine"
[[ -z $ROOTPWD ]] && ROOTPWD="selfmicro" # Must be changed @first login
[[ -z $OPI_USERNAME ]] && OPI_USERNAME="enjoy" 
[[ -z $OPI_PWD ]] && OPI_PWD="enjoy" 
[[ -z $MAINTAINER ]] && MAINTAINER="Selfmicro Marine" # deb signature
[[ -z $MAINTAINERMAIL ]] && MAINTAINERMAIL="enjoy@selfmicro.com" # deb signature
